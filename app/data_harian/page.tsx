...
import DataHarianInteractiveSection from "./widget";

export default function DataHarian() {
  return (
    <div className="p-6 space-y-5">
      <DataHarianInteractiveSection
        className="space-y-5" />
      <div>
        ...
        <div className="grid grid-cols-[repeat(auto-fit,minmax(7rem,1fr))] gap-2 w-full">
          <Link href={"/data_harian/daftar_pesanan"} className="w-full flex justify-center">
          ...
          <Link href={"/data_harian/pemasukan"} className="w-full flex justify-center">
            <button className="h-28 w-full rounded-lg flex flex-col items-center justify-center space-y-2 bg-blue-200 active:scale-90 transition-all">
          ...
          <Link href={"/data_harian/pengeluaran"} className="w-full flex justify-center">
            <button className="h-28 w-full rounded-lg flex flex-col items-center justify-center space-y-2 bg-blue-200 active:scale-90 transition-all">
