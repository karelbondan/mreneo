    ...
    <div className="p-6 space-y-5">
      ...
      <div>
        ...
        <div className="grid grid-cols-[repeat(auto-fit,minmax(7rem,1fr))] gap-2 w-full">
          <Link href={setHref("/data/pesanan")} className="w-full flex justify-center">
          ...
          <Link href={setHref("/data/pemasukan")} className="w-full flex justify-center">
            <button className="h-28 w-full rounded-lg flex flex-col items-center justify-center space-y-2 bg-blue-200 active:scale-90 transition-all">
          ...
          <Link href={setHref("/data/pengeluaran")} className="w-full flex justify-center">
            <button className="h-28 w-full rounded-lg flex flex-col items-center justify-center space-y-2 bg-blue-200 active:scale-90 transition-all">
